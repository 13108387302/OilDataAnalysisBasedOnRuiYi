...
-- 二级菜单：具体功能模块
INSERT IGNORE INTO sys_menu VALUES
(2001, '任务分析', '2000', '3', 'analysis', 'petrol/analysis/index', '', '', 1, 0, 'C', '0', '0', 'petrol:analysis:list', 'el-icon-data-analysis', 'admin', NOW(), '', null, '分析任务管理'),
...
(2003, '模型管理', '2000', '4', 'model', 'petrol/model/index', '', '', 1, 0, 'C', '0', '0', 'petrol:model:list', 'el-icon-cpu', 'admin', NOW(), '', null, '模型管理'),
(2004, '预测管理', '2000', '5', 'prediction', 'petrol/prediction/index', '', '', 1, 0, 'C', '0', '0', 'petrol:prediction:list', 'el-icon-trend-charts', 'admin', NOW(), '', null, '预测管理'),
(2005, '数据集管理', '2000', '1', 'dataset', 'petrol/dataset/index', '', '', 1, 0, 'C', '0', '0', 'petrol:dataset:list', 'el-icon-folder-opened', 'admin', NOW(), '', null, '数据集管理');
...
(2015, '任务导出', '2001', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:analysis:export', '#', 'admin', NOW(), '', null, ''),
(2016, '任务详情', '2001', '6', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:analysis:detail', '#', 'admin', NOW(), '', null, '');

-- 三级菜单：数据可视化功能按钮
INSERT IGNORE INTO sys_menu VALUES
(2021, '可视化查询', '2002', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:visualization:query', '#', 'admin', NOW(), '', null, ''),
(2022, '可视化新增', '2002', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:visualization:add', '#', 'admin', NOW(), '', null, ''),
(2023, '可视化修改', '2002', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:visualization:edit', '#', 'admin', NOW(), '', null, ''),
(2024, '可视化删除', '2002', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:visualization:remove', '#', 'admin', NOW(), '', null, ''),
(2025, '可视化导出', '2002', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:visualization:export', '#', 'admin', NOW(), '', null, '');

-- 三级菜单：模型管理功能按钮
INSERT IGNORE INTO sys_menu VALUES
(2031, '模型查询', '2003', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:model:query', '#', 'admin', NOW(), '', null, ''),
(2032, '模型新增', '2003', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:model:add', '#', 'admin', NOW(), '', null, ''),
(2033, '模型修改', '2003', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:model:edit', '#', 'admin', NOW(), '', null, ''),
(2034, '模型删除', '2003', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:model:remove', '#', 'admin', NOW(), '', null, ''),
(2035, '模型导出', '2003', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:model:export', '#', 'admin', NOW(), '', null, ''),
(2036, '模型详情', '2003', '6', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:model:detail', '#', 'admin', NOW(), '', null, '');

-- 三级菜单：预测管理功能按钮
INSERT IGNORE INTO sys_menu VALUES
(2041, '预测查询', '2004', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:prediction:query', '#', 'admin', NOW(), '', null, ''),
(2042, '预测新增', '2004', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:prediction:add', '#', 'admin', NOW(), '', null, ''),
(2043, '预测修改', '2004', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:prediction:edit', '#', 'admin', NOW(), '', null, ''),
(2044, '预测删除', '2004', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:prediction:remove', '#', 'admin', NOW(), '', null, ''),
(2045, '预测导出', '2004', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:prediction:export', '#', 'admin', NOW(), '', null, ''),
(2046, '预测详情', '2004', '6', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:prediction:detail', '#', 'admin', NOW(), '', null, '');

-- 三级菜单：数据集管理功能按钮
INSERT IGNORE INTO sys_menu VALUES
(2051, '数据集查询', '2005', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:query', '#', 'admin', NOW(), '', null, ''),
(2052, '数据集新增', '2005', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:add', '#', 'admin', NOW(), '', null, ''),
(2053, '数据集修改', '2005', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:edit', '#', 'admin', NOW(), '', null, ''),
(2054, '数据集删除', '2005', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:remove', '#', 'admin', NOW(), '', null, ''),
(2055, '数据集导出', '2005', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:export', '#', 'admin', NOW(), '', null, ''),
(2056, '数据集导入', '2005', '6', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:import', '#', 'admin', NOW(), '', null, ''),
(2057, '数据集预览', '2005', '7', '#', '', '', '', 1, 0, 'F', '0', '0', 'petrol:dataset:preview', '#', 'admin', NOW(), '', null, '');
